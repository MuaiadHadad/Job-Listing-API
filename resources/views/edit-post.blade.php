      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-12 ftco-animate text-center mb-5">
          	<p class="breadcrumbs mb-0"><span class="mr-3"><a href="{{ route('browsejobs') }}">My Posts <i class="ion-ios-arrow-forward"></i></a></span> <span>Edit Post</span></p>
            <h1 class="mb-3 bread">Edit A Post</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
                  <div class="container">
                      ...
                      @endif
                      <form action="{{ route('job.update', $job->id) }}" method="POST" class="p-5 bg-white">
                          @csrf
                          @method('PUT')
                          ...
                          <div class="row form-group mb-5">
                              <div class="col-md-12 mb-3 mb-md-0">
                                  ...
                                  <input type="text" id="company" name="company_name" class="form-control" value="{{ $job->company_name  }}">
                          ...
                          <div class="row form-group">
                              ...
                              <div class="col-md-12 mb-3 mb-md-0">
                                  <label>
                                      <input type="radio" name="job_type" value="full-time" {{ $job->job_type === 'full-time' ? 'checked' : '' }}> Full Time
                                  </label>
                              </div>

                              <div class="col-md-12 mb-3 mb-md-0">
                                  <label>
                                      <input type="radio" name="job_type" value="part-time" {{ $job->job_type === 'part-time' ? 'checked' : '' }}> Part Time
                                  </label>
                              </div>

                              <div class="col-md-12 mb-3 mb-md-0">
                                  <label>
                                      <input type="radio" name="job_type" value="remote" {{ $job->job_type === 'remote' ? 'checked' : '' }}> Remote
                                  </label>
                              </div>

                              <div class="col-md-12 mb-3 mb-md-0">
                                  <label>
                                      <input type="radio" name="job_type" value="Internship" {{ $job->job_type === 'Internship' ? 'checked' : '' }}> Internship
                                  </label>
                              </div>

                              <div class="col-md-12 mb-3 mb-md-0">
                                  <label>
                                      <input type="radio" name="job_type" value="Temporary" {{ $job->job_type === 'Temporary' ? 'checked' : '' }}> Temporary
                                  </label>
                              </div>
                          </div>
                          ...
                          <div class="row form-group">
                              ...
                              <div class="col-md-12 mb-3 mb-md-0">
                                  <textarea name="description" class="form-control" cols="30" rows="5">{{ $job->description }}</textarea>
